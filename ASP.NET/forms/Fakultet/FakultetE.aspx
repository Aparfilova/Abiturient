...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="FakultetE.aspx.cs" Inherits="IIS.Abiturient.ФакультетE" %>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlНазваниеФакультетаLabel" runat="server" Text="Название факультета" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlНазваниеФакультета" runat="server">
</asp:TextBox>
