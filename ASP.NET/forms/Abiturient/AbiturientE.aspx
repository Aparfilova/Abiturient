...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="AbiturientE.aspx.cs" Inherits="IIS.Abiturient.АбитуриентE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlГородLabel" runat="server" Text="Город" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlГород" runat="server">
</asp:TextBox>
